    ...
    <aside id="profile" className="twitter-panel">
      <div className="profile-banner">
        <Link
          ...
          style={{ backgroundImage: props.profile.banner != null ? `url('${props.profile.banner}')` : none }}
        />
      </div>
      ...
      <div className="profile-body">
        ...
        <Link to={"/" + props.profile.userName} className="profile-name">
          {props.profile.name}
        </Link>

        <Link to={"/" + props.profile.userName} className="profile-userName">
